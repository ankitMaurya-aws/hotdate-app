        ...
        <header className='py-8 bg-black-20 sticky top-0 z-[99] xl:static xl:bg-transparent xl:pt-10 xl:py-0'>
            <div className='flex flex-wrap justify-between xl:justify-center items-center xl:items-start px-5 xl:px-[10%]'>
                <div className='w-1/2 xl:w-1/5 pr-5'>
                    <img src="images/Hot-Date.png" alt="Logo" className='cursor-pointer' />
                </div>
                <span className='block xl:hidden w-10 cursor-pointer' onClick={()=>setMenuOpen(!menuOpen)}>
                    <img src="images/toggle-btn.png" alt="toggle" className='w-full' />
                </span>
                <div className={`xl:w-4/5 mobile_db_header ${menuOpen ? 'mobile_db_header_open':''}`}>
                <div className='flex-wrap grid xl:flex content-start xl:items-start mobile_db_header_inner relative'>
                    <span className='text-xl text-white absolute top-3 right-5 flex z-9 xl:hidden cursor-pointer' onClick={()=>setMenuOpen(false)}><RxCross1 /></span>
                    ...
                    <div className='xl:w-4/5'>
                        <form>
                            <div className='relative text-white '>
                                <span className='absolute top-1/2 left-5 transform -translate-y-1/2 text-2xl flex items-center'><IoSearchOutline /></span>
                                <input type="search" className='outline-none border-none w-full px-5 pl-16 h-14 bg-light-grey rounded-xl' />
                            </div>
                        </form>
                        <div className='db_header_nav w-full'>
                            <ul className='xl:flex items-center justify-between mt-10 grid gap-y-2'>
                                <li><Link to='/home'>Homepage</Link></li>
                                <li><Link to='/home'>Live Chat</Link></li>
                                <li><Link to='/home'>About</Link></li>
                                <li><Link to='/home'>Contact</Link></li>
                                <li className='link'><Link to='/home'>Join now</Link></li>
                            </ul>
                        </div>
                    </div>
