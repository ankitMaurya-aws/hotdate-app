               ...
               <div
                      ...
                      onChange={(e) => handleChange(e)} id="password" autocomplete="off"
                          ...
                          value={rememberMe} className="sm:w-[29px] sm:h-[31px] border border-gray-300 rounded bg-gray-50 focus:ring-3
                                    ...
                                    <button className="gradient !py-3 w-full !text-lg xl:!text-25px uppercase !font-bold flex justify-center items-center text-white rounded-xl primary_btn"   onClick={(e) => handleLogin(e)}>Login</button>
