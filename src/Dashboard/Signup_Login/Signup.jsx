              ...
              <div className="sign-up__form flex flex-col justify-center gap-30 py-6 px-6 lg:py-11 lg:px-14">
                ...
                >
                  <div className="flex flex-wrap p-[2px] gradient rounded-md">
                    <label
                      htmlFor="email"
                      className="rounded-l-md gradient w-[195px] h-[49px] flex items-center justify-center lg:justify-start px-2 lg:px-4 text-sm xl:text-lg text-white  font-normal leading-5 xl:leading-29 text-center 
                                            lg:text-start"
                    >
                      Email address
                    </label>
