...
const LandingLayout = () => {
    ...
    return (
        <div className={`${Lplayout === 'dark_layout' ? 'bg-black text-white' : 'bg-white text-black'} min-h-screen overflow-hidden grid content-between`}>
            <div className='min-h-[calc(100vh-409px)]'>
                <Header Lplayout={Lplayout} />
                <Outlet />
            </div>
            {
            LpFooterlayout === 'footer_layout_1' ?
            <Footer />
            :
            <Footer2 />
            }
