            ...
            <div className='container mx-auto'>
                <div className='landingpage_header flex flex-wrap items-center justify-between'>
                    <div className='w-[150px]'>
                        <img src='landingPage/images/landing-logo.png' className='cursor-pointer max-w-100px block' />
                    </div>
                    <div className="flex items-center lg:hidden">
                        <button onClick={()=>setOpenMenu(!openMenu)} className="items-center text-3xl
                            text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2
                            focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                            <CgMenuRightAlt />
                        </button>
                    </div>
                    <div className={`${openMenu ? 'lp_navbar_open': ''} lp_navbar lg:w-[calc(100%-150px)]`}>
