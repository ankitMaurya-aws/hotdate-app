...
const ImageTextOverlay = () => {
    return (
        <section
        className="mt-16 hero__section adult-community-image banner_2 relative adult-community z-0 flex justify-center xl:justify-center items-start bg-adult-community-image bg-no-repeat min-h-screen
        ">
        <div className="container">
            <div
                className="content flex justify-center xl:justify-end items-center xl:items-end text-white ms-0 md:ms-[55%] max-w-500">
                <div
                    className="inner-block relative z-1 flex flex-col justify-center xl:justify-start items-center lg:items-start text-center lg:text-start before:transform before:translate-x-1/2 before:absolute before:content-[''] before:w-[502px] before:h-[502px] before:top-0 before:right-0 before:bg-red-500 before:blur-[200px] before:rounded-502 before:-z-1">
