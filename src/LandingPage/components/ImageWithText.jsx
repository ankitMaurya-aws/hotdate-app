...
const ImageWithText = () => {
    ...
    before:absolute before:content-[''] before:w-[502px] before:h-[502px] before:right-0
    before:bg-no-repeat before:bg-cover before:bg-yellow before:blur-[150px] before:rounded-502 before:bottom-[-20%] before:z-[-2]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div className="left-block flex justify-center lg:justify-end items-center">
                    <div className="inner-block max-w-500">
                        <p className="text-xl xl:text-35px leading-45 font-light max-w-[360px]">Find Partner, Hook-up, and Chat
                            Live at</p>
                        <h2 className="text-2xl md:text-4xl xl:text-50px leading-75 font-bold">Kaizenglobe.com!</h2>
